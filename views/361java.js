...
(function(){
	...
	var answerContainers = quizContainer.querySelectorAll('.answers');
        ...
        if(userAnswer === currentQuestion.correctAnswer){  //if correct
          ...
          info = currentQuestion.endBlurb;
        }
      
      });

      resultsContainer.innerHTML = 'You were most likely bitten by a(n) ' + '<a href="glossary.html">'+ result + '</a>.<p>' + '<img src"" height="200px" width="200px"><p>' + blurb;
    ...
    var myQuestions = [
          ...
          },
      {
       image: "<img src=https://static01.nyt.com/images/2020/01/20/podcasts/00JAN-TINYLOVE-6/00JAN-TINYLOVE-6-mediumSquareAt3X.jpg height=200px width=200px>",
        ...
        correctAnswer: "a",
        endResult: "Flea",
        endBlurb: "Fleas typically stay at ground level and jump to bite at ankles and feet. They cannot survive on human blood, and so you will often find that the source of the infestation comes from an animal or pet."
      },
      {
        image: "<img src=https://static01.nyt.com/images/2020/01/20/podcasts/00JAN-TINYLOVE-6/00JAN-TINYLOVE-6-mediumSquareAt3X.jpg height=200px width=200px>",
        ...
        correctAnswer: "a",
        endResult: "Mosquito",
        endBlurb: "Mosquitoes have been known to carry disease. Check with your physician if you have symptoms other than itchiness after getting bitten by one."
      },
      {
        image: "<img src=https://static01.nyt.com/images/2020/01/20/podcasts/00JAN-TINYLOVE-6/00JAN-TINYLOVE-6-mediumSquareAt3X.jpg height=200px width=200px>",
        ...
        correctAnswer: "a",
        endResult: "Bedbug",
        endBlurb: "Bedbugs are nocturnal, only coming out at night to feast. Wash all linens and sheets with hot water and vaccuum."
      },
      {
        image: "<img src=https://static01.nyt.com/images/2020/01/20/podcasts/00JAN-TINYLOVE-6/00JAN-TINYLOVE-6-mediumSquareAt3X.jpg height=200px width=200px>",
        ...
        correctAnswer: "a",
        endResult: "Tick",
        endBlurb: "Ticks can carry lyme disease which is characterized by a bullseye-like rash. See a physician if this is the case. Otherwise, most people don't know they've been bitten by a tick."
      },
      {
        image: "<img src=https://static01.nyt.com/images/2020/01/20/podcasts/00JAN-TINYLOVE-6/00JAN-TINYLOVE-6-mediumSquareAt3X.jpg height=200px width=200px>",
        ...
        endBlurb: "Mite/Chigger typically appear in the wild and are almost microscopic. Unlike popular belief, they do not burrow into the skin."
      }
    ];
    buildQuiz();
...
//www.w3schools.com (dropit function)  
////https://simplestepscode.com/javascript-quiz-tutorial/#step1 (buildquiz function)
